  ...
  -- customize alpha options
  {
    ...
    opts = function(_, opts)
      ...
      opts.section.buttons.val = {
        ...
        dashboard.button("f", get_icon("FindFile", 2, true) .. "Find File  ", "<CMD>Telescope find_files<CR>"),
        dashboard.button("r", get_icon("DefaultFile", 2, true) .. "Recents  ", "<CMD>Telescope oldfiles <CR>"),
        dashboard.button("t", get_icon("FindText", 2, true) .. "Find Text  ", "<CMD>Telescope live_grep<CR>"),
        -- dashboard.button("s", get_icon("Refresh", 2, true) .. "Last Session  ", "<Leader>Sl"),
        dashboard.button("c", get_icon("Gear", 2, true) .. "Configuration  ", "<CMD>Lazy<CR>"),
